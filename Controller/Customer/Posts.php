...
class Posts implements ActionInterface, HttpGetActionInterface
{
    ...
    public function execute(): ResultInterface
    {
        ...
        $this->registry->register(
            Constant::PARAM_PAGE,
            $this->params->getPage(Constant::PAGER_CUSTOMER_POSTS)
        );
        $this->registry->register(
            Constant::PARAM_LIMIT,
            $this->params->getLimit(Constant::PAGER_CUSTOMER_POSTS, Constant::DEFAULT_PAGE_SIZE_POST)
        );
        $this->registry->register(
            Constant::PARAM_SORT,
            $this->params->getSort(Constant::PAGER_CUSTOMER_POSTS, Constant::SORT_CREATED_DESC)
        );
