...
class MassReject extends AdminIndex
{
    ...
    public function execute(): ResultInterface
    {
        ...
        foreach ($ids as $id) {
            try {
                ...
                $model->load((int) $id);
                $model->setStatus(PostInterface::STATUS_DISABLED);
                $model->save();
                $count++;
            } catch (\Exception $e) {
        ...
        $this->messageManager->addSuccess(__('A total of %1 record(s) have been rejected.', $count));
