...
namespace Ronald2Wing\Forum\Model\ResourceModel\Moderator\Grid;
...
class Collection extends AbstractCollection implements SearchResultInterface
{
    ...
    protected $_eventPrefix = 'ronald2wing_forum_moderator_grid_collection';
    protected $_eventObject = 'moderator_grid_collection';
    ...
    {
        $this->_init(Moderator::class, \Ronald2Wing\Forum\Model\ResourceModel\Moderator::class);
    }
